...
<div class="sideBar sidebarOpen" style="top:68px;" id="sidebar">
  <div class="sideBar__menu">
    ...
    <div class="sideBar__box">
      <a href="<?= home_url('/spot-noreserve/'); ?>" class="sideBar__title"><span class="sidebar__icon"><i class="fas fa-slash fa-fw"></i></span><span class="sideBar__titleCharacter">予約不可設定</span></a>
    </div>
    <div class="sideBar__box">
    ...
    <div class="sideBar__box">
      ...
      <ul class="sideBar__block open">
        ...
        <li class="sideBar__list"><a href="<?= home_url('/mypage-default-reservation/'); ?>">デフォルトの面談日程</a></li>
...
<script>
  ...
  // $(".-clickTarget").next().forEach(function(item){
  //   console.log(item);
  // })
  ...
  //   sidebar.querySelectorAll(".sideBar__titleCharacter").forEach((item) => {
