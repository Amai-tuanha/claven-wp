...
include(plugin_dir_path(__FILE__) . "load-head.php");
...
function my_wpdb_page()
{
    ...
    // ---------- 変数ファイル ----------
    include(plugin_dir_path(__FILE__) . "variables.php");

    // ---------- wpdbのアクション ----------
    include(plugin_dir_path(__FILE__) . "/model/wpdb-actions.php");

    // ---------- テンプレート読み込み ----------
    include(plugin_dir_path(__FILE__) . "view/pages/views.php");
}

// ---------- 読み込み ----------
include(plugin_dir_path(__FILE__) . "load-footer.php");