...
<p>
    ...
    public function sendTestDonationEmailReceipt( $form, $transactionData, $subject, $body ) {
        ...
        $sender = new MM_WPFS_TestDonationReceiptSender( $transactionData, $form );
    ...
    public function sendTestOneTimePaymentReceipt( $form, $transactionData, $subject, $body ) {
        ...
        $sender = new MM_WPFS_TestOneTimePaymentReceiptSender( $transactionData, $form );
        $sender->setSubject( $subject );
        $sender->setBody( $body );
        $sender->sendEmail();
    }
    ...
    public function sendTestSaveCardNotification( $form, $transactionData, $subject, $body ) {
        ...
        $sender = new MM_WPFS_TestSaveCardNotificationSender( $transactionData, $form );
        $sender->setSubject( $subject );
        $sender->setBody( $body );
        $sender->sendEmail();
    }
    ...
    public function sendTestSubscriptionStartedEmailReceipt( $form, $transactionData, $subject, $body ) {
        ...
        $sender = new MM_WPFS_TestSubscriptionEmailReceiptSender( $transactionData, $form );
        $sender->setSubject( $subject );
        $sender->setBody( $body );
        $sender->sendEmail();
    }
    ...
    public function sendTestSubscriptionFinishedEmailReceipt( $form, $transactionData, $subject, $body ) {
        ...
        $sender = new MM_WPFS_TestSubscriptionEndedNotificationSender( $transactionData, $form );
        $sender->setSubject( $subject );
        $sender->setBody( $body );
        $sender->sendEmail();
    }
    ...
    public function sendTestMyAccountLoginRequest( $transactionData, $subject, $body ) {
        ...
        $sender = new MM_WPFS_TestMyAccountLoginNotificationSender( $transactionData );
        $sender->setSubject( $subject );
        $sender->setBody( $body );
        $sender->sendEmail();
    }
