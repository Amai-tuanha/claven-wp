    ...
    $(function () {
        ...
        function initEmailTemplateView( templateId ) {
            ...
            var testEmailOptions = {
                ...
                formFields:                     {
                    'wpfs-test-email-addresses':  createInputTags( FORM_FIELD_TEST_EMAIL_ADDRESSES )
                },
        ...
        function createInputTags( name ) {
            ...
            return createFieldDescriptor( FIELD_TYPE_TAGS, name, clazz, selector, errorClass, errorSelector );
        }
